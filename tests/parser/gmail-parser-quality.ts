...
const CASES: Case[] = [
  ...
  {
    name: 'NEW_FR_body_parenthesized_arrival_departure_blocks',
    messageId: 'msg_new_parenthesized_blocks_001',
    subject: 'Réservation confirmée : Eve Danloup arrive le 20 mai',
    from: 'Automated Airbnb <automated@airbnb.com>',
    receivedAt: '2026-04-29T10:00:00.000Z',
    body: [
      'Code de confirmation : HM22EV44MA',
      'Arrivée',
      '(mer. 20 mai)',
      '16:00',
      'Départ',
      ...
      '10:00',
      '2 voyageurs',
      'Vos revenus pour ce séjour : 76 CHF',
    ].join('\n'),
    expected: {
      bookingType: 'new',
      minConfidence: 70,
      ...
      expectedCheckOut: '2026-05-22',
      expectedNights: 2,
      expectedGuestNameIncludes: ['Eve', 'Danloup'],
    },
  },
  {
    name: 'NEW_FR_body_quoted_printable_arrival_departure',
    messageId: 'msg_new_qp_001',
    subject: 'Réservation confirmée : Eve Danloup arrive le 20 mai',
    from: 'Automated Airbnb <automated@airbnb.com>',
    receivedAt: '2026-04-29T10:00:00.000Z',
    body: [
      'Code de confirmation : HMQP22EV01',
      'Arriv=C3=A9e',
      'mer. 20 mai',
      '16:00',
      'D=C3=A9part',
      ...
      '10:00',
      '2 voyageurs',
      'Vos revenus pour ce s=C3=A9jour : 76 CHF',
    ].join('\n'),
    expected: {
      bookingType: 'new',
      minConfidence: 70,
  ...
  {
    name: 'NEW_FR_no_year_dates_must_follow_receivedAt_year',
    messageId: 'msg_new_no_year_refdate_001',
    subject: 'Réservation confirmée : Eve Danloup arrive le 20 mai',
    from: 'Automated Airbnb <automated@airbnb.com>',
    receivedAt: '2024-04-29T10:00:00.000Z',
    body: [
      'Code de confirmation : HMRY24EV01',
      'Arrivée',
      '(mer. 20 mai)',
      '16:00',
      'Départ',
    ...
    expected: {
      ...
      hasConfirmationCode: true,
      requiresDates: true,
      expectedCheckIn: '2024-05-20',
      expectedCheckOut: '2024-05-22',
      expectedNights: 2,
      expectedGuestNameIncludes: ['Eve', 'Danloup'],
    },
  },
  ...
  {
    name: 'NEW_FR_inline_arrivee_depart_should_extract_2_nights',
    messageId: 'msg_new_inline_arrivee_depart_001',
    subject: 'Nouveau voyage : Julie Deneuvy arrive le 18 sept.',
    from: 'automated@airbnb.com',
    ...
    body: [
      ...
      'HMABC12345',
      'Vos revenus pour ce séjour : 64,00 €',
    ].join('\n'),
    expected: {
      bookingType: 'new',
      minConfidence: 70,
      hasConfirmationCode: true,
      requiresDates: true,
      expectedCheckIn: '2026-09-18',
      expectedCheckOut: '2026-09-20',
      expectedNights: 2,
      expectedGuestNameIncludes: ['Julie', 'Deneuvy'],
      minGuests: 2,
    },
  },
  {
    name: 'NEW_FR_typo_month_fevirer_should_still_parse',
    messageId: 'msg_new_typo_fevirer_001',
    subject: 'Réservation confirmée : Clara arrive le 10 fevirer 2026',
    from: 'automated@airbnb.com',
    receivedAt: '2026-01-20T09:00:00.000Z',
    body: [
      'Code de confirmation : HMFEV1026',
      'Arrivée : 10 fevirer 2026',
      'Départ : 12 fevirer 2026',
      '2 voyageurs',
      'Vos revenus pour ce séjour : 120,00 €',
    ].join('\n'),
    expected: {
      bookingType: 'new',
      minConfidence: 70,
      hasConfirmationCode: true,
      requiresDates: true,
      expectedCheckIn: '2026-02-10',
      expectedCheckOut: '2026-02-12',
      expectedNights: 2,
      minGuests: 2,
    },
  },
  {
    name: 'NEW_FR_month_fev_with_comma_should_parse',
    messageId: 'msg_new_month_fev_comma_001',
    subject: 'Réservation confirmée : Emma arrive le 10 fév, 2026',
    from: 'automated@airbnb.com',
    receivedAt: '2026-01-20T09:00:00.000Z',
    body: [
      'Code de confirmation : HMFEVCOM26',
      'Arrivée : 10 fév, 2026',
      'Départ : 12 fév, 2026',
      '2 voyageurs',
      'Vos revenus pour ce séjour : 140,00 €',
    ].join('\n'),
    expected: {
      bookingType: 'new',
      minConfidence: 70,
  ...
  {
    name: 'NEW_FR_month_fevrier_without_accent_should_parse',
    messageId: 'msg_new_month_fevrier_no_accent_001',
    subject: 'Réservation confirmée : Léo arrive le 10 fevrier 2026',
    from: 'automated@airbnb.com',
    receivedAt: '2026-01-20T09:00:00.000Z',
    body: [
      'Code de confirmation : HMFEVRIER26',
      'Arrivée : 10 fevrier 2026',
      'Départ : 12 fevrier 2026',
      '2 voyageurs',
      'Vos revenus pour ce séjour : 150,00 €',
    ].join('\n'),
    expected: {
      bookingType: 'new',
      minConfidence: 70,
  ...
  {
    // Reproduit le layout HTML réel Airbnb : Arrivée et Départ dans des <td> adjacents
    // → après stripping HTML : "Arrivée\nDépart\nven. 18 sept.\n16:00\ndim. 20 sept.\n10:00"
    name: 'NEW_FR_table_layout_two_column_arrivee_depart',
    messageId: 'msg_table_two_col_001',
    subject: 'Réservation confirmée ! Mathieu arrive le 19 juin',
    from: 'automated@airbnb.com',
    receivedAt: '2026-05-02T10:00:00.000Z',
    body: [
      'Mathieu Dupont',
      'Identité vérifiée · 5 commentaires',
      'Maison de ville avec petite Terrasse couverte',
      'Logement entier',
      // Layout tableau : labels côte à côte puis dates côte à côte
      'Arrivée',
      'Départ',
      'jeu. 19 juin',
      '16:00',
    ...
    expected: {
      ...
      hasConfirmationCode: true,
      requiresDates: true,
      expectedCheckIn: '2026-06-19',
      expectedCheckOut: '2026-06-20',
      expectedNights: 1,
      expectedGuestNameIncludes: ['Mathieu', 'Dupont'],
    },
  },
  {
    name: 'NEW_FR_user_sample_julie_deneuvy',
    messageId: 'msg_new_julie_deneuvy_001',
    subject: 'Nouvelle réservation confirmée ! Julie arrive le 18 sept.',
    from: 'automated@airbnb.com',
    receivedAt: '2026-08-25T09:15:00.000Z',
    body: [
      'Julie Deneuvy',
      'Identité vérifiée · 10 commentaires',
      'bonjour nous serons 2 parents avec nos fils qui font la coupe de france de bmx à troyes',
      'Maison de ville avec petite Terrasse couverte',
      'Logement entier',
      'Arrivée',
      'ven. 18 sept.',
  ...
  {
    // Layout tableau Airbnb HTML RÉEL pour Julie : labels côte à côte PUIS dates côte à côte
    // Ce cas reproduit exactement ce que retourne Gmail API après stripping HTML
    name: 'NEW_FR_julie_deneuvy_real_html_table_layout',
    messageId: 'msg_new_julie_deneuvy_002',
    subject: 'Nouvelle réservation confirmée ! Julie arrive le 18 sept.',
    from: 'automated@airbnb.com',
    receivedAt: '2026-08-25T09:15:00.000Z',
    body: [
      ...
      'Maison de ville avec petite Terrasse couverte',
      'Logement entier',
      // Layout HTML tableau : Arrivée et Départ dans des <td> côte à côte → même ligne après stripping
      'Arrivée',
      'Départ',
      'ven. 18 sept.',
      '16:00',
