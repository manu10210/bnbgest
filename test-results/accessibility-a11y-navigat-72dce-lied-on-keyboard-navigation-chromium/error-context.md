...
- Name: accessibility\a11y-navigation.spec.ts >> Accessibility - Navigation Structure >> Focus visible CSS should be applied on keyboard navigation
- Location: tests\e2e\accessibility\a11y-navigation.spec.ts:106:7
...
Call log:
  ...
  - waiting for locator(':focus-visible')
