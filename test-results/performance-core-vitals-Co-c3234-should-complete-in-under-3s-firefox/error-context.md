...
- Name: performance\core-vitals.spec.ts >> Core Web Vitals - Homepage >> Page load should complete in under 3s
- Location: tests\performance\core-vitals.spec.ts:98:7
