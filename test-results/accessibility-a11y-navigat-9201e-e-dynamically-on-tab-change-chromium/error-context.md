...
- Name: accessibility\a11y-navigation.spec.ts >> Accessibility - Navigation Structure >> Breadcrumbs should update dynamically on tab change
- Location: tests\e2e\accessibility\a11y-navigation.spec.ts:86:7
...
Locator: locator('[aria-current="page"]')
Expected substring: "Tableau de bord"
Timeout: 5000ms
