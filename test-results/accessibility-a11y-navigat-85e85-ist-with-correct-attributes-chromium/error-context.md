...
- Name: accessibility\a11y-navigation.spec.ts >> Accessibility - Navigation Structure >> Main landmark should exist with correct attributes
- Location: tests\e2e\accessibility\a11y-navigation.spec.ts:43:7
...
Locator: locator('main#main-content')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('main#main-content')
