...
- Name: performance\core-vitals.spec.ts >> Bundle Performance >> Total JavaScript size should be reasonable
- Location: tests\performance\core-vitals.spec.ts:133:7
