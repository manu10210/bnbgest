...
- Name: accessibility\a11y-navigation.spec.ts >> Accessibility - Navigation Structure >> Breadcrumbs navigation should have correct ARIA
- Location: tests\e2e\accessibility\a11y-navigation.spec.ts:64:7
...
Locator: locator('nav[aria-label="Fil d\'Ariane"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav[aria-label="Fil d\'Ariane"]')
